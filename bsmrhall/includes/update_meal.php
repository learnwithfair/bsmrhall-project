...
<div class="modal fade bd-example-modal-md" id="update-meal" tabindex="-1" role="dialog"
        ...
        <div class="modal-content modal_icon">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-title" id="exampleModalLongTitle">
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02"
                            name="u-morning-meal" value="<?php echo $meal_info['morning_meal']; ?>"
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02" name="u-lunch"
                            value="<?php echo $meal_info['lunch']; ?>" placeholder="Enter Lunch" required />
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02"
                            name="u-dinner" value="<?php echo $meal_info['dinner']; ?>" placeholder="Enter Dinner"
                            required />
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-warning btn-sm" name="update-meal-btn"
