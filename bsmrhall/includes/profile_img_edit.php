            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-title" id="exampleModalLongTitle">
                    ...
                    <div class="profile-img-div">
                        <img src="./pdf/uploads/<?php echo $info['non_r_img']; ?>" id="updatephoto" />
                        <input type="file" id="imgfile" name="user_img" accept="image/jpg, image/png" />
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-warning btn-sm" name="user_img_btn"
