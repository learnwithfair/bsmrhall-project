...
<div class="modal fade bd-example-modal-md" id="add-meal" tabindex="-1" role="dialog"
        ...
        <div class="modal-content modal_icon">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-title" id="exampleModalLongTitle">
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02"
                            name="morning-meal" value="1" placeholder="Enter Morning Meal" required />
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02" name="lunch"
                    ...
                    <div class="form-outline mb-4">
                        <input type="number" max="3" min="0" class="form-control" id="validationCustom02" name="dinner"
                            value="1" placeholder="Enter Dinner" required />
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-warning btn-sm" name="add-meal-btn"
