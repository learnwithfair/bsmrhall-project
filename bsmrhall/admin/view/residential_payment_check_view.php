...
<?php
    ...
    if ( isset( $_POST['r_roll_query_show'] ) ) {
        $varify_status = $obj->check_r_payment( $_POST );
    }
...
<div class="card mb-4" style="border:2px solid #dee2e6;">
                    ...
                    <div class="col-8">
                        <div class="form-outline">
                            <input type="number" class="form-control" name="search_r_roll" id="form4Example1"
                                ...
                                value="<?php if ( isset( $_SESSION['check_r_roll'] ) ) {echo $_SESSION['check_r_roll'];}?>"
                                required />
    ...
    <div class="card-body" style="padding:10px">
        <?php
            if ( isset( $_SESSION['check_r_roll'] ) ) {
                $r_data = $obj->residential_info_by_roll( $_SESSION['check_r_roll'] );
            ?>
        <!-- Roll Info -->
        ...
        <?php
                ...
                $r_year_data        = $obj->r_unique_info( $_SESSION['check_r_roll'] );
        ...
        <div style="border:2px solid #dee2e6;padding:10px">
            ...
            <div class="table-responsive">
                <table class="table table-bordered vertical_align r_info_td_align" id="border-color" width="100%"
                    ...
                    <tbody>
                        <?php
                            $r_unique_data = $obj->r_unique_info( $_SESSION['check_r_roll'] );
        ...
        <div style="margin:30px 0px;">
            <form action="../pdf/r_info_pdf.php" method="post">
                <div class="d-flex justify-content-end text-center">
                    <input type="hidden" value="<?php echo $_SESSION['check_r_roll'] ?>" name="rpdfinfo">
